...
define('SU_IS_BANMASTER', 134217728);
...
define('SU_EDIT_BANS',SU_MEGAUSER | SU_IS_BANMASTER);

define('CLAN_APPLICANT',0);
define('CLAN_MEMBER',10);
define('CLAN_OFFICER',20);
define('CLAN_ADMINISTRATIVE',25);
...
$date = new DateTime();
define('DATETIME_TODAY',$date->format('Y-m-d H:i:s'));
