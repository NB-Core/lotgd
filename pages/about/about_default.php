    ...
    switch ($current_rank) {
        case "3":
            ...
            output("If you use this core, you need to be aware of the goals of my optimizations:`n`n<ul>", true);
               output("<li>PHP 8.0 or newer is required</li>", true);
               output("<li>MySQL 5.0 or later (MariaDB compatible) is required</li>", true);
            ...
            output("</ul>`n`n", true);
            output("For the download of this version please go to the github repository at <a href='https://github.com/NB-Core/lotgd/releases'>https://github.com/NB-Core/lotgd/releases</a> where the latest development version (snapshots) and stable versions are hosted.`n`n", true);
