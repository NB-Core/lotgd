...
final class ErrorHandlerUnknownLabelTest extends TestCase
{
    ...
    public function testUnknownErrorLabelIsUsed(): void
    {
        ErrorHandler::errorNotify(9999, 'Test error', 'file.php', 42, '<trace>');

        $this->assertSame(1, $GLOBALS['mail_sent_count']);
        $this->assertStringStartsWith('LotGD Unknown on', $GLOBALS['last_subject']);
    }
}
