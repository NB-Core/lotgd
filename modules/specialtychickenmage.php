    ...
    switch ($hookname) {
        ...
        case "choose-specialty":
            if (
                ...
                if (get_module_setting("reqmoons") && is_module_active("moons")) {
                    ...
                    $fullmoon = 0;
                    if ($moon1 && ($moon1place < $moon1cycle * 0.62) && ($moon1place >= $moon1cycle * 0.5)) {
                        $fullmoon = 1;
                    }
                    if ($moon2 && ($moon2place < $moon2cycle * 0.62) && ($moon2place >= $moon2cycle * 0.5)) {
                        $fullmoon = 1;
                    }
                    if ($moon3 && ($moon3place < $moon3cycle * 0.62) && ($moon3place >= $moon3cycle * 0.5)) {
                        $fullmoon = 1;
                    }
        ...
        case "incrementspecialty":
            if ($session['user']['specialty'] == $spec) {
                ...
                output(
                    "`n%sYou gain a level as a `&%s%s to `#%s%s!",
                    $c,
                    $name,
                    $c,
                    $new,
        ...
        case "fightnav-specialties":
            ...
            if ($uses > 1) {
                addnav(
                    array("$ccode &#149; Swarm of Chicks`7 (%s)`0", 2),
            ...
            if ($uses > 2) {
                addnav(
                    array("$ccode &#149; Fluttering Hens`7 (%s)`0", 3),
            ...
            if ($uses > 4) {
                addnav(
                    array("$ccode &#149; Squawkin' Fightin' Rooster`7 (%s)`0", 5),
